...
Namespace DXSample.ViewModels
    ...
    Public Class MainViewModel
        ...
        Public Sub New()
            Panels = New ObservableCollection(Of PanelViewModel)() From {New PanelViewModel() With {.Caption = "One", .Content = "A regular panel", .TargetName = "documentGroup"}, New PanelViewModel() With {.Caption = "Two", .Content = "A regular panel", .TargetName = "documentGroup"}, New PanelViewModel() With {.Caption = "Three", .Content = "A regular panel", .TargetName = "documentGroup"}, New PanelViewModel() With {.Caption = "Five", .Content = "A panel", .TargetName = "layoutGroup"}}
        End Sub
    End Class
